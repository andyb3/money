...
class TX_History(forms.Form):
    ...
    end_date = forms.DateField(label_suffix="",label="Period end", widget=forms.TextInput(attrs={'class':'datepicker','autocomplete':'off'}))
    ...
    def __init__(self, *args, **kwargs):
        ...
        for account in Account.objects.all():
            ...
            self.fields[str(account.pk)] = forms.BooleanField(label_suffix="",label=account.description, required=False, initial=True)
